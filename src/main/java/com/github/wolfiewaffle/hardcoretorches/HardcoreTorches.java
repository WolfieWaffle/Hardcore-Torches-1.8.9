...
public class HardcoreTorches {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		configFreeLightItems = config.getStringList("configFreeLightItems", Configuration.CATEGORY_GENERAL, new String[] {"minecraft:lava_bucket", "hardcoretorches:torch_lit", "hardcoretorches:torch_coke_lit"}, "A list of items that can be used to light a torch. These will not be damaged or consumed.");
